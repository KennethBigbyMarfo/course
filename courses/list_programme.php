...
$prog = new MySQL();
$prog->Query("SELECT * FROM departments where isacademic=1 ORDER BY name");
...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
	<title>TERM - PROGRAMME LIST</title>
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span12">
                        <table align="center" class="table">
                            <tr>
                                <td colspan="2"><h5><strong>List of Programme</strong></h5></td>
                                <td></td>
                            </tr>
                        </table>
                        <hr>
                        <form method="POST" action="" id="find_course_form">
                            ...
                            <table style="width: 650px;" align="center" class="table table-striped table-bordered table-hover table-responsive">
                                ...
                                <tr>
                                    <th colspan="3" style="text-align: center;"><h5><strong>FILTER BY Department</strong></h5></th>
                                </tr>
                                </thead>
                                <tbody>
                            ...
                            <div class="modal-content">
                                <div id="printableArea">
                                    <div class="modal-header" style="text-align: center;">
                                        ...
                                        <div><h5><strong><i class="icon icon-edit"></i> Programme Details</strong></h5></div>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $btns.click(function (e) {
                ...
                $.ajax({
                    type: "POST",
                    url: "process_programme_search.php",
