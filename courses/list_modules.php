                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span12">
                        <table align="center" class="table">
                            <tr>
                                <td colspan="2"><h5><strong>List of Modules</strong></h5></td>
                                <td></td>
                            </tr>
                        </table>
                        <hr>
                        ...
                        <div>
                            <p align="center" style="display: none; color: limegreen;" id="wait"><img src="../img/select2/spinner.gif" > Searching for modules. Please wait....</p>
                        </div>
                    </div>
