            ...
            <div id="pad-wrapper" class="new-user">
                ...
                <div class="row-fluid form-wrapper">
                    ...
                    <div class="span12">
                        ...
                        <div style="display:none; color: limegreen;" id="wait"><img src="../img/select2/spinner.gif" > Creating course. Please wait....</div>
                        <div class="container">
                            ...
                            <form method="post" name="form1" id="frmAdmin" action="" class="form-wrapper">
                              ...
                              <table align="center" class="table table-striped table-bordered">
                                  <tr>
                                      <td colspan="4" style="text-align: center;"><h5><strong>Create Course</strong></h5></td>
                                  </tr>
                                <tr>
                                ...
                                <input type="hidden" name="do" value="insertCourse">
                    ...
                    $.ajax({
                        ...
                        success: function(e) {
                             ...
                             if(e=="c_ok"){
                                ...
                                $('#result').html("<br><div align='center'><span class='alert alert-success' style='text-align: center;'><i class='icon icon-ok-sign'></i> Course created successfully</span></div><br>").hide().fadeIn(1000);
                                $("#code").val("");
                                 $("#name").val("");
                                 $("#desc").val("");
                                ...
                                $('#result').html("<br><div align='center'><span class='alert alert-danger' style='text-align: center;'><i class='icon icon-remove-sign'></i> Course creation failed</span></div><br>").hide().fadeIn(1000);
                                $("#wait").css("display","none");
                                $("#save").removeAttr('disabled');
                                 $("#close").removeAttr('disabled');

                            }
                            else if(e=="c_codeexists"){

                                $('#result').html("<br><div align='center'><span class='alert alert-danger' style='text-align: center;'><i class='icon icon-remove-sign'></i> Course Code Already Exists.</span></div><br>").hide().fadeIn(1000);
                                $("#wait").css("display","none");
                                $("#save").removeAttr('disabled');
                                 $("#close").removeAttr('disabled');
